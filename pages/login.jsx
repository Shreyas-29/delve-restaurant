    ...
    if (session) {
        return (
            <div>
                ...
                <div className='container mx-auto flex flex-col items-center justify-center gap-8 lg:!h-[70vh]'>
                    <div className='inset-0 flex items-center justify-center'>
                        <div className='flex flex-col items-center justify-center py-12 px-16 border rounded-3xl'>
        ...
        return (
            <div className='container mx-auto px-20 items-center flex justify-center flex-col gap-8 lg:!h-[70vh]'>
                <Head>
                    <title>Delve | Login </title>
                    <link rel="icon" href="/favicon.svg" />
                </Head>
                <div className='inset-0 flex items-center justify-center'>
                    <div className='flex flex-col items-center justify-center py-8 px-6 border rounded-3xl'>
